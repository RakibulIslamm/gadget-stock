...
const NewsLetter = () => {
    return (
        <div className=' bg-gray-100 py-5'>
            <div className="px-[80px] container md:w-2/3 xl:w-auto mx-auto  flex flex-col xl:items-stretch justify-between xl:flex-row">
                ...
                <div className="w-full xl:w-1/2 xl:pl-40 xl:py-28 ">
                    ...
                    <div className="flex items-stretch mt-12">
                        <input className="bg-gray-300 focus:bg-white rounded-lg rounded-r-none text-base leading-none text-gray-800 p-5 w-4/5 border border-transparent focus:outline-none focus:border-gray-500" type="email" placeholder="Your Email" />
